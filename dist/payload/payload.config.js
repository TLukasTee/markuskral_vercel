...
var CustomDashboard_1 = __importDefault(require("./components/CustomDashboard"));
...
exports.default = (0, config_1.buildConfig)({
    admin: {
        css: path_1.default.resolve(__dirname, './hyd_custom.css'),
        ...
        components: {
            ...
            views: {
                Dashboard: CustomDashboard_1.default,
            },
            graphics: {
                Icon: icon_1.default,
            },
    ...
    collections: [Products_1.default, Categories_1.default, Users_1.default, Orders_1.Orders, Media_1.Media, Pages_1.Pages],
    globals: [],
    typescript: {
