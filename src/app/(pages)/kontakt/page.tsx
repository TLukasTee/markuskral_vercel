...
export default async function kontakt() {
  return (
    ...
    <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      ...
      <form action="https://submit-form.com/qTwk5A0sR" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
      <input
    type="hidden"
    name="_redirect"
  ...
  />
        <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="message" className="block text-sm font-semibold leading-6 text-gray-900">
                Nachricht (Interesse an einem bestimmten Objekt?)
              </label>
              <div className="mt-2.5">
                <textarea
                  name="message"
          ...
          <div className="mt-8 flex justify-end">
            <button
              type="submit"
              className="rounded-md bg-red-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
